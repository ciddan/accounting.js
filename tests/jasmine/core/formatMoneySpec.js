describe('formatMoney()', function(){
  ...
  it('should work with different prefix/suffix combinations', function(){

    expect( accounting.formatMoney(123, 0, '', ',-' ) ).toBe( '123,-' );
    expect( accounting.formatMoney(123.45, 2, '£ ', ' GBP') ).toBe( '£ 123.45 GBP' );
    expect( accounting.formatMoney(12345.67, 2, '$') ).toBe( '$12,345.67' );
